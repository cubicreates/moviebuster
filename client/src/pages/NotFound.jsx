      ...
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] text-white p-4 text-center">
        <div className="max-w-md w-full space-y-8 bg-moviebuster-darkblue p-8 rounded-lg shadow-lg border-2 border-moviebuster-yellow animate-fade-in">
          ...
          <div className="space-y-7">
            <h1 className="text-6xl font-bold mb-4 text-moviebuster-yellow">404</h1>
            ...
            <div className="mt-6">
              <Link to="/" className="px-6 py-3 bg-moviebuster-blue text-white rounded-md hover:bg-moviebuster-blue/90 transition font-medium">
                Go to Home
              </Link>
            </div>
          </div>
